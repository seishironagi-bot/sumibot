...
const taguser = '@' + m.sender.split('@s.whatsapp.net')[0];
    let pp = await conn.profilePictureUrl(m.messageStubParameters[0], 'image').catch(_ => 'https://qu.ax/awSVD.jpg')
    let pp2 = await conn.profilePictureUrl(m.messageStubParameters[0], 'image').catch(_ => 'https://qu.ax/awSVD.jpg')
...
await conn.sendFile(m.chat, img, "Thumbnail.jpg", wel, null, rcanal)
  }
